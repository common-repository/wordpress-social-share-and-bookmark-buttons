...
function display_html($url_to_reference) {
	...
	$html_to_display .= '<div style="position: relative; top: 3px; left: 5px; width: 76px; height: 80px;">';
	...
	$html_to_display .= ' <su:badge layout="5" location="'.$url_to_reference.'"></su:badge>';
