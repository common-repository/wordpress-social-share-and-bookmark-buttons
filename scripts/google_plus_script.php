...
function display_html($url_to_reference) {
	...
	$html_to_display .= '<div style="position: relative; top: 3px; left: -3px; width:60px; height:80px;">';

	$html_to_display .= '<g:plusone size="tall" annotation="bubble" width="130" href="'.$url_to_reference.'" ></g:plusone>';
